...
def batch_gradient_descent(NN, weights, biases, weight_gradients, bias_gradients, X, y, iterations=5000, learning_rate=0.01,
...
def mini_batch_gradient_descent(weights, biases, weight_gradients, bias_gradients, X, y, iterations=5000,
                                learning_rate=0.01, reg_lambda=0.01, regularize=False):
    """
    implements simple batch gradient descent
    :param weights: tuple of numpy weight arrays
    :param biases: tuple of numpy bias arrays
